...
const styles = StyleSheet.create({
  container: { padding: 16, paddingBottom: 120, backgroundColor: '#ebe9f6' },
  headerTitle: { fontSize: 26, fontWeight: '800', marginBottom: 6, color: '#49289e' },
  headerSubtitle: { fontSize: 15, color: '#666', marginBottom: 20 },
  card1: { backgroundColor: '#f6ebf9', borderRadius: 18, padding: 18, marginBottom: 18, elevation: 3 },
  card2: { backgroundColor: '#ebf9f2', borderRadius: 18, padding: 18, marginBottom: 18, elevation: 3 },
  card3: { backgroundColor: '#f6f9eb', borderRadius: 18, padding: 18, marginBottom: 18, elevation: 3 },
  card4: { backgroundColor: '#f9ebec', borderRadius: 18, padding: 18, marginBottom: 18, elevation: 3 },
  card5: { backgroundColor: '#ecf9eb', borderRadius: 18, padding: 18, marginBottom: 18, elevation: 3 },
  cardTitle: { fontSize: 17, fontWeight: '700', marginBottom: 14, color: '#28369e' },
